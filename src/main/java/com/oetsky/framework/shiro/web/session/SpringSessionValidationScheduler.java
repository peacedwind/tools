...
import com.oetsky.common.utils.Threads;
...
public class SpringSessionValidationScheduler implements SessionValidationScheduler {
    ...
    private static final Logger log = LoggerFactory
        .getLogger(SpringSessionValidationScheduler.class);
    ...
    /**
     * Specifies how frequently (in milliseconds) this Scheduler will call the {@link
     * org.apache.shiro.session.mgt.ValidatingSessionManager#validateSessions()
