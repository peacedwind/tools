package com.oetsky.framework.shiro.web.session;
...
import com.oetsky.project.monitor.online.service.UserOnlineServiceImpl;
    ...
    public void validateSessions() {
        ...
        for (UserOnline userOnline : userOnlineList) {
            try {
                ...
                userOnlineService
                    .removeUserCache(userOnline.getLoginName(), userOnline.getSessionId());
            }
