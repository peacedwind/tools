package com.oetsky.common.utils.file;

import com.oetsky.common.constant.Constants;
import com.oetsky.common.exception.file.FileNameLengthLimitExceededException;
import com.oetsky.common.exception.file.FileSizeLimitExceededException;
import com.oetsky.common.exception.file.InvalidExtensionException;
import com.oetsky.common.utils.DateUtils;
import com.oetsky.common.utils.StringUtils;
import com.oetsky.common.utils.uuid.IdUtils;
...
public class FileUploadUtils {
     ...
     * 默认上传的地址
     */
    private static String defaultBaseDir = OetskyConfig.getProfile();
    ...
    public static final String getPathFileName(String uploadDir, String fileName)
        throws IOException {
        int dirLastIndex = OetskyConfig.getProfile().length() + 1;
