package com.oetsky.common.utils.poi;

import com.oetsky.common.exception.UtilException;
import com.oetsky.common.utils.DateUtils;
import com.oetsky.common.utils.StringUtils;
import com.oetsky.common.utils.file.FileTypeUtils;
import com.oetsky.common.utils.file.FileUtils;
import com.oetsky.common.utils.file.ImageUtils;
...
import com.oetsky.framework.aspectj.lang.annotation.Excel.Type;
import com.oetsky.framework.aspectj.lang.annotation.Excels;
...
public class ExcelUtil<T> {
            ...
            for (int i = titleNum + 1; i <= rows; i++) {
                ...
                for (Map.Entry<Integer, Object[]> entry : fieldsMap.entrySet()) {
                    ...
                    if (StringUtils.isNotNull(fieldType)) {
                        ...
                        } else if (ColumnType.IMAGE == attr.cellType() && StringUtils
                            .isNotEmpty(pictures)) {
                            PictureData image = pictures
                                .get(row.getRowNum() + "_" + entry.getKey());
                            if (image == null) {
                                val = "";
                            } else {
    ...
    public void setCellVo(Object value, Excel attr, Cell cell) {
        if (ColumnType.STRING == attr.cellType()) {
            ...
            if (StringUtils.isNotNull(value)) {
                cell.setCellValue(
                    StringUtils.contains(Convert.toStr(value), ".") ? Convert.toDouble(value)
                        : Convert.toInt(value));
            }
    ...
    public String dataFormatHandlerAdapter(Object value, Excel excel) {
        try {
            ...
            Method formatMethod = excel.handler()
                .getMethod("format", Object.class, String[].class);
        ...
        if (!pictures.isEmpty()) {
            for (HSSFShape shape : sheet.getDrawingPatriarch().getChildren()) {
                ...
                if (shape instanceof HSSFPicture) {
                    ...
                    String picIndex =
                        anchor.getRow1() + "_" + anchor.getCol1();
