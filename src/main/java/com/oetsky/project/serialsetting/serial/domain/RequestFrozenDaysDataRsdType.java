 ...
 * @author zhangw
 */
public class RequestFrozenDaysDataRsdType {
    /**
     * RSD TYPE  数据位    26位
     */
    ...
    /**
     * 获取 冻结时间  位数    8位（类型1+数据7） 2
     *
     * @return dateTimeStr 冻结时间  位数    8位（类型1+数据7） 2
     */
    ...
    /**
     * 设置 冻结时间  位数    8位（类型1+数据7） 2
     *
     * @param dateTimeStr 冻结时间  位数    8位（类型1+数据7） 2
     */
     ...
     * 获取 冻结时间  位数    7位  2
     *
     * @return dateTimeVal 冻结时间  位数    7位  2
     */
     ...
     * 设置 冻结时间  位数    7位  2
     *
     * @param dateTimeVal 冻结时间  位数    7位  2
     */
