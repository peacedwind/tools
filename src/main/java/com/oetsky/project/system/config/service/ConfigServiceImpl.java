package com.oetsky.project.system.config.service;
...
import com.oetsky.project.system.config.mapper.ConfigMapper;
...
public class ConfigServiceImpl implements IConfigService {
    ...
    public int insertConfig(Config config) {
        ...
        if (row > 0) {
            CacheUtils
                .put(getCacheName(), getCacheKey(config.getConfigKey()), config.getConfigValue());
        }
        return row;
    }
