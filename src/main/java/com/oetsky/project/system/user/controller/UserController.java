...
import com.oetsky.common.utils.security.AuthorizationUtils;
...
import com.oetsky.project.system.post.service.IPostService;
import com.oetsky.project.system.role.domain.Role;
import com.oetsky.project.system.role.service.IRoleService;
...
public class UserController extends BaseController {
    ...
    public String add(ModelMap mmap) {
        mmap.put("roles", roleService.selectRoleAll().stream().filter(r -> !r.isAdmin())
    ...
    public AjaxResult addSave(@Validated User user) {
        if (UserConstants.USER_NAME_NOT_UNIQUE
            .equals(userService.checkLoginNameUnique(user.getLoginName()))) {
    ...
    public String edit(@PathVariable("userId") Long userId, ModelMap mmap) {
        ...
        mmap.put("roles", User.isAdmin(userId) ? roles
