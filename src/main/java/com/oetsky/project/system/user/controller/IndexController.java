package com.oetsky.project.system.user.controller;

import com.oetsky.common.constant.ShiroConstants;
import com.oetsky.common.utils.CookieUtils;
...
import com.oetsky.project.system.menu.domain.Menu;
import com.oetsky.project.system.menu.service.IMenuService;
...
public class IndexController extends BaseController {
    ...
    @Autowired
    private OetskyConfig oetskyConfig;
    ...
    public String index(ModelMap mmap) {
        ...
        Boolean tagsView = Convert
            .toBool(configService.selectConfigByKey("sys.index.tagsView"), true);
        mmap.put("footer", footer);
        mmap.put("tagsView", tagsView);
        mmap.put("mainClass", contentMainClass(footer, tagsView));
        mmap.put("copyrightYear", oetskyConfig.getCopyrightYear());
        mmap.put("demoEnabled", oetskyConfig.isDemoEnabled());
        mmap.put("isDefaultModifyPwd", initPasswordIsModify(user.getPwdUpdateDate()));
        mmap.put("isPasswordExpired", passwordIsExpiration(user.getPwdUpdateDate()));
        mmap.put("isMobile",
            ServletUtils.checkAgentIsMobile(ServletUtils.getRequest().getHeader("User-Agent")));
        ...
        for (Cookie cookie : cookies) {
            if (StringUtils.isNotEmpty(cookie.getName()) && "nav-style"
    ...
    public String main(ModelMap mmap) {
        mmap.put("version", oetskyConfig.getVersion());
        return "main";
    }
    ...
    public boolean initPasswordIsModify(Date pwdUpdateDate) {
        Integer initPasswordModify = Convert
            .toInt(configService.selectConfigByKey("sys.account.initPasswordModify"));
