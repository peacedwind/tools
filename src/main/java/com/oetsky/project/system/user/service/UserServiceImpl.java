package com.oetsky.project.system.user.service;
...
import com.oetsky.framework.aspectj.lang.annotation.DataScope;
import com.oetsky.framework.shiro.service.PasswordService;
import com.oetsky.project.system.config.service.IConfigService;
import com.oetsky.project.system.post.domain.Post;
import com.oetsky.project.system.post.mapper.PostMapper;
import com.oetsky.project.system.role.domain.Role;
import com.oetsky.project.system.role.mapper.RoleMapper;
import com.oetsky.project.system.user.domain.User;
import com.oetsky.project.system.user.domain.UserPost;
import com.oetsky.project.system.user.domain.UserRole;
import com.oetsky.project.system.user.mapper.UserMapper;
import com.oetsky.project.system.user.mapper.UserPostMapper;
import com.oetsky.project.system.user.mapper.UserRoleMapper;
...
public class UserServiceImpl implements IUserService {
    ...
    public int insertUser(User user) {
        ...
        user.setPassword(passwordService
            .encryptPassword(user.getLoginName(), user.getPassword(), user.getSalt()));
        ...
        for (User user : userList) {
            try {
                ...
                if (StringUtils.isNull(u)) {
                    ...
                    successNum++;
                    successMsg
                        .append("<br/>" + successNum + "、账号 " + user.getLoginName() + " 导入成功");
                } else if (isUpdateSupport) {
                    user.setUpdateBy(operName);
                    this.updateUser(user);
                    successNum++;
                    successMsg
                        .append("<br/>" + successNum + "、账号 " + user.getLoginName() + " 更新成功");
                } else {
                    failureNum++;
